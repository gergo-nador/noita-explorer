// from https://github.com/IvanSanchez/Leaflet.ImageOverlay.Rotated/blob/gh-pages/Leaflet.ImageOverlay.Rotated.js
...
// @ts-expect-error we are creating this type now
...
export function rotatedImageOverlay(
  imgSrc: string | ImageData,
  topleft: L.LatLng,
  topright: L.LatLng,
  bottomleft: L.LatLng,
  options: unknown,
) {
  // @ts-expect-error Rotated exists, we just added
