...
const xml = `
 <Entity 
      ...
      <AbilityComponent 
        ...
        mCastDelayStartFrame="193031" 
        mChargeCount="0" 
        mIsInitialized="1" 
        mNextFrameUsable="193032" 
        mReloadFramesLeft="29" 
        mReloadNextFrameUsable="193060" 
        mana="520" 
        mana_charge_speed="154" 
        mana_max="520" 
        max_amount_in_inventory="1" 
        max_charged_actions="0" 
        never_reload="0" 
        reload_time_frames="29" 
      ...
      <ItemComponent 
        ...
        mFramePickedUp="171291" 
        max_child_items="0" 
        next_frame_pickable="187314" 
      ...
      <Entity 
        ...
        <SpriteComponent 
          ...
          fog_of_war_hole="0" 
          has_special_scale="0" 
          image_file="data/ui_gfx/gun_actions/long_distance_cast.png" 
          is_text_sprite="0" 
          kill_entity_after_finished="0" 
          never_ragdollify_on_death="0" 
          next_rect_animation="" 
          offset_animator_offset.x="-0" 
          offset_animator_offset.y="-0.884996" 
          offset_x="8" 
          offset_y="17" 
          rect_animation="" 
          smooth_filtering="0" 
        ...
        <SpriteComponent 
          ...
          fog_of_war_hole="0" 
          has_special_scale="0" 
          image_file="data/ui_gfx/inventory/item_bg_utility.png" 
          is_text_sprite="0" 
          kill_entity_after_finished="0" 
          never_ragdollify_on_death="0" 
          next_rect_animation="" 
      ...
      <Entity 
        ...
        <SpriteComponent 
          ...
          fog_of_war_hole="0" 
          has_special_scale="0" 
          image_file="data/ui_gfx/gun_actions/teleport_projectile.png" 
          is_text_sprite="0" 
          kill_entity_after_finished="0" 
          never_ragdollify_on_death="0" 
          next_rect_animation="" 
          offset_animator_offset.x="-0" 
          offset_animator_offset.y="-0.688108" 
          offset_x="8" 
          offset_y="17" 
          rect_animation="" 
          smooth_filtering="0" 
...
parseXml(xml).then((parsed) => {
  const xmlWrapper = XmlWrapper(parsed).findNthTag('Entity')!;
  const wand = __scrapeWand(xmlWrapper);
